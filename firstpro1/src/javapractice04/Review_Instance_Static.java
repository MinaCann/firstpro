...
public class Review_Instance_Static {

	//JVM creates automatically one thread for each class. Thats called main thread.This thread will create RunTime Stack. 
	//The thread will call on the main method(FILO).

	
	String name;//null
	int age;//0
	
	Review_Instance_Static(String name,int age){
		this.name=name;
		this.age =age;
	...
	public static void main(String[] args) {
		//m1()
		//m2()
     Review_Instance_Static obj = new Review_Instance_Static("Mumine", 33);
     System.out.println(obj.name + " is " +obj.age +" yerars old.");
	}
